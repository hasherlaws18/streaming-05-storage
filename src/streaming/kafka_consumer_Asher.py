...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m streaming.kafka_consumer_Asher
...
OUTPUT_CSV: Final[Path] = OUTPUT_DIR / "consumed_sales-Asher.csv"
OUTPUT_DB: Final[Path] = OUTPUT_DIR / "sales-Asher.duckdb"
